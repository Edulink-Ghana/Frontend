...
const SignUp17 = () => {
	return (
		<section className="ezy__signup16 light flex items-center justify-center py-14 md:py-24 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white overflow-hidden bg-gradient-to-r from-[#6a11cb] to-[#2575fc]">
